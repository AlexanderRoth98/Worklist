...
<h1>Rate Company</h1>
<p>
    Rate company for instance : {{uiLink}}
</p>
<p>
  Please enter a rating in form of ONE letter from F to A, where A is the best and F is the worst
</p>
<p>
  !REMEMBER THAT IF YOU VOTE C OR LESS YOU WILL BE OPEN FOR WORK AGAIN AND NOT START A PERMANENT JOB!
</p>
 <div id="margin">
 <label>Rating:</label>
  ...
  components: {
    ...
    submit: function () {
     ...
     Vue.axios.put(this.uiLink, {rating: this.rating}).then(response => console.log(response));
       ...
       let postPath = "http://abgabe.cs.univie.ac.at:9202" + "/finished/" + this.user + "/" + "RateCompany";
